...
if __name__ == "__main__":
    ...
    num = db.reprocessByAll(level=options.level,
                            startDate=startDate, endDate=endDate)

    print('Added {0} files to be reprocessed for All'.format(num))
    DBlogging.dblogger.info('Added {0} files to be reprocessed for All'.format(num))
